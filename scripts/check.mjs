...
const requiredMain = [
  '<title>Регистрация спецтехники в Гостехнадзоре под ключ | ТехУчёт</title>',
  'content="Постановка на учёт, снятие с учёта, перерегистрация и техосмотр самоходной техники в Гостехнадзоре. Сопровождение под ключ для физических и юридических лиц."',
  'Регистрация спецтехники в Гостехнадзоре под ключ',
  'от 5 000 ₽',
  'Постановка на учёт, снятие с учёта, перерегистрация и техосмотр самоходной техники. Берём сопровождение оформления на себя.',
  'Без привоза техники',
...
const requiredMainFaq = [
  ...
  'Нужно ли привозить технику?',
  'Работаете ли вы с юридическими лицами?',
  'Госпошлины входят в стоимость услуги?',
  'Что делать при отказе или нестандартной ситуации?',
];
for (const question of requiredMainFaq) {
  if (!main.includes(question)) errors.push(`index.html: commercial FAQ missing "${question}"`);
}

for (const bannedGeo of ['Москва и МО', 'Москва и Московская область', 'Санкт-Петербург и Ленинградская область', 'по месту нахождения', 'организуем осмотр']) {
  if (main.includes(bannedGeo)) errors.push(`index.html: banned text found "${bannedGeo}"`);
}
