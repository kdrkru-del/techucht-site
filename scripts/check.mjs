...
const requiredMain = [
  ...
  'Без скрытых обещаний: заранее согласовываем услугу, стоимость и порядок работы.',
  'Сначала разбираемся в вашей задаче, называем стоимость и только после этого начинаем работу.',
